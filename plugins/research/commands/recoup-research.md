...
1. Resolves the artist (name, Spotify URL, or any streaming URL)
2. Pulls profile, Spotify metrics, listener cities, audience demographics,
...
- `recoup-web-intelligence` (fallback if Chartmetric data unavailable)
...
- Competitive positioning (career stage, momentum, peer landscape)
