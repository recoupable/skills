...
| Creative brief | `recoup-release-marketing-brief` | `brief/` |
| Schedule | `recoup-release-campaign` | `campaign/` |
| Master doc + deliverables | `recoup-release-doc` | `RELEASE.md`, `reports/` |
| Targeting | `recoup-playlist-intelligence` → `recoup-people-outreach` (research) | `targeting/` |
| Post-release | `recoup-new-release-monitor`, `recoup-streaming-check`, `recoup-weekly-brief` | `tracking/` |
