...
The full curl-by-curl playbook for steps 1–8 lives in the [`recoup-artist-create`](https://github.com/recoupable/skills/tree/main/plugins/recoup-essentials/skills/recoup-artist-create) skill and on the docs site at `https://developers.recoupable.com/skills/create-artist`. Load that skill once at scaffold time and follow its 8-step chain.
