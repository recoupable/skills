...
- **Playlist questions** → hand off to `recoup-artist-playlists`
- **Audience/market questions** → hand off to `recoup-artist-audience`
- **Competitor/roster comparison** → hand off to `recoup-artist-competition`
- **Trending/discovery questions** → hand off to `recoup-artist-scout`
- **People/outreach questions** → hand off to `recoup-artist-outreach`
