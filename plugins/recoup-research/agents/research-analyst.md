...
- `recoup-playlist-intelligence` — playlist analysis
- `recoup-audience-analysis` — demographics and geography
- `recoup-competitive-analysis` — peer comparison
- `recoup-trend-detection` — discovery and charts
- `recoup-people-outreach` — contacts and outreach
