---
name: recoup-artist-scout
description: A&R discovery of emerging/unsigned artists you don't already track, plus viral song analysis, via the Recoup research API. Use when asked to find emerging artists, discover new talent, scout a genre or scene, or understand why a song went viral. Triggers on "find emerging artists", "A&R scouting", "discover artists", "why did this go viral", "viral song", "trending", "emerging [genre]", "breakout artists", "who's next in [genre]".
---
