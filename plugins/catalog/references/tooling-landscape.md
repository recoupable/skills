...
to replace them. The strongest position is a deal-review and analysis layer
that turns exports, files, and APIs into source-cited deal workpapers.
...
| --- | --- | --- |
| Curve | Label and publisher royalty accounting, statement ingestion, contract terms, CWR, reporting. | Deal-specific review, cross-room evidence trails, valuation normalization, IC packaging. |
| RoyaltyShare | Royalty processing for labels, especially Orchard-connected workflows. | Independent buyer deal review across mixed external data rooms. |
...
and create deal-review workpapers. Do not mutate these systems without a
...
| Tool | What it solves | What remains manual |
| --- | --- | --- |
| OpenPlay | Catalog metadata, rights, assets, delivery, API source of truth. | Acquisition review, valuation bridges, seller-file reconciliation. |
| DISCO | Asset management, pitching, tagging, rights lookup, sync workflows. | Financial review and cross-source royalty normalization. |
...
| Chartmetric | Artist, playlist, social, radio, and platform analytics. | Royalty tie-outs, NPS/NLS, rights review. |
...
| BMAT, Soundmouse, Audoo | Usage detection, broadcast, cue sheets, public performance monitoring. | Translating detections into deal-review exceptions and value impact. |
...
| Duetti | Independent catalog acquisition needs fast master/publishing deal review and post-close operations. |
...
Plugin role: create faster deal-review packets, financing packages, and IC
memos from the same normalized evidence base.
...
- Do not replace legal review by counsel.
