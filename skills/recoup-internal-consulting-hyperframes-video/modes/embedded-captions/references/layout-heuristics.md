...
- **Pillarbox / letterbox hard check.** If the source has black bars (see pre-flight probe in GUIDE.md), compute `leftmost_text_x` using the correct formula for the text alignment:
