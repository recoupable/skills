...
Four phases, four spring feels, four ease choices. The complete spring → ease mapping table lives in hyperframes-animation/GUIDE.md (`../GUIDE.md`); this blueprint's defaults are:
