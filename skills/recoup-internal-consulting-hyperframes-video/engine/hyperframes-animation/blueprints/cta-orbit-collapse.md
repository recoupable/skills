...
Five spring-shaped beats, four `back.out` coefficients plus one sine yoyo. Full mapping table lives in hyperframes-animation/GUIDE.md (`../GUIDE.md`); the intent-to-ease pairing here is:
