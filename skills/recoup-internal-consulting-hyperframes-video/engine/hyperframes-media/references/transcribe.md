...
3. Produced music track (vocals + full instrumentation) → start with `medium.en`; expect to need manual lyrics or an external API (`captions/transcript-handling.md` → "Using External Transcription APIs")
