---
name: recoup-internal-consulting-content-drafter
description: "INTERNAL — Recoup staff consulting workflow. Use for recoup-internal consulting requests. Turn an idea or insight into a publish-ready draft. Use on \"draft a post/blog about X\", \"write this up\", or when promoting a signal from signals/."
---
...
2. **Ground research-derived drafts (pull the wiki).** If the idea cites `[[wiki pages]]` (it came
   from `recoup-internal-consulting-research-miner`) or the topic is agent/skill/AI-engineering-shaped, follow
