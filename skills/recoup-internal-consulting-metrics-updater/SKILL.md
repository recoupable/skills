---
name: recoup-internal-consulting-metrics-updater
description: "INTERNAL — Recoup staff consulting workflow. Use for recoup-internal consulting requests. Refresh the practice metrics and dashboard. Use monthly, after a deal changes state, or \"update the dashboard/metrics\". Good scheduled-task candidate."
---
...
2. Refresh `business/metrics/dashboard.html` (funnel counts, client table, KPI tiles).
