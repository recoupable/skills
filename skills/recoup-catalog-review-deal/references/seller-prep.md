...
1. Run `recoup-catalog-review-deal` (review mode) to scaffold the deal workspace for seller prep.
2. Inventory files and build missing-document tracker.
3. Use `recoup-catalog-review-deal` (ingest mode) to normalize metadata and royalty statements.
4. Use `recoup-catalog-review-deal` to find unsupported assets.
5. Use `recoup-catalog-review-deal` to find income leakage and statement gaps.
