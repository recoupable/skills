...
- `references/video-music-artist.md` — **artist music video (real song, real face)** — the Brauxelion 27s recipe (NB2 → OmniHuman/Wan/H3 → HyperFrames), YT transcript via yt-dlp auto-sub (es.vtt), cost ledger and 3-round bake-offs; clone `content/letal-xlug/` for Tomas Mika
