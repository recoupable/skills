...
- `references/video-music-artist.md` — **artist music video**: a real artist's released song cut to 9:16 with their real face and master. The five gates that each cost money on the reference build, the three-model motion split (OmniHuman for mouths, Wan 3.0 for silent faces, H3 Max for no-face plates) and why H3 must stay in its lane, word-timing sources, and the bake-off-inclusive cost ledger
