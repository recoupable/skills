...
| A **real artist's released song** is the whole story, cut to 9:16 with their real face and real master | **Artist music video** (face guide → stills → three-model motion split → composite to the track) | `references/music-video.md`. Clone `content/letal-xlug/`. Three separate rights gates, and the artist approves the look, the cut and the credit |
