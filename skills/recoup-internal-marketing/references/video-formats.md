...
| A **real artist's released song** is the whole story, cut to 9:16 against their real master | **Artist music video** (story from the artist's direction or from the lyrics → ask for their photos → build their likeness → Muse Image stills → H3 Max motion → composite to the track) | `references/music-video.md`. Clone `content/letal-xlug/` in the account workspace. Ask for their face AND full-body photos in the first message; the artist's own likeness is the default. The artist approves the look, the cut and the credit |
