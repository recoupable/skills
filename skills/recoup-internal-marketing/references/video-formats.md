...
| A **real artist's released song** is the whole story, cut to 9:16 against their real master | **Artist music video** (story from the artist's direction or from the lyrics → cast characters → Muse Image stills → OmniHuman for mouths, H3 Max for everything else → composite to the track) | `references/music-video.md`. Clone `content/letal-xlug/` in the account workspace. No face guide; the artist is on camera only if the film needs them. The artist approves the look, the cut and the credit |
